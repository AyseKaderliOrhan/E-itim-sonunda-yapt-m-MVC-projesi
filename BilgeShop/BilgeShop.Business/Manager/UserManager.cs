...
namespace BilgeShop.Business.Manager
{
    public class UserManager : IUserService
    {
        ...
        public ServiceMessage AddUser(AddUserDto addUserDto)
        {
            ...
            if (hasMail.Any()) // hasMail is nut null
            {
        ...
        public UserDto Login(LoginDto loginDto)
        {
            ...
            {
                return null; // eğer form üzerinden gönderilen email adresi ile aşleşen bir veri tabloda yoksa, oturum açılmayacağı için, geriye de hiç bir veri dönmüyorum.
            }
