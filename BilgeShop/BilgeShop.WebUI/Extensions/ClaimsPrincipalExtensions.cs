...
namespace BilgeShop.WebUI.Extensions
{
    ...
    // cookie'de tutulan verilerin kontrllerini yapmak için yazılacak metotları bu class içinde tutuyorum.
    public static class ClaimsPrincipalExtensions
    {
        ...
        public static int GetUserId(this ClaimsPrincipal user)
        {
            ...
            // ? koymazsak, olmayan bir kaydın value'sunu almaya kalkarken patlar. Ben bunun mümkün olduğunu, sorun olmadığını belirtiyorum.
        }
